...
namespace eosio {
   ...
   /**
    * @defgroup  nordicenergy
    * @ingroup nordicenergycontracts
    *
    * nordicenergy contract
    *
    * @details nordicenergy contract defines the structures and actions that allow users to create, issue, and manage
    * tokens on eosio based blockchains.
    * @{
    */
   class [[eosio::contract("nordicenergy")]] token : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiotoken nordicenergy
} /// namespace eosio
